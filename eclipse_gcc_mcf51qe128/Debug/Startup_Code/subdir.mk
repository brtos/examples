...
Startup_Code/%.o: ../Startup_Code/%.S
	...
	m68k-elf-gcc -mcpu=51 -g3 -Os -ffunction-sections -fdata-sections -x assembler-with-cpp -DDEBUG_BUILD -I"C:/DADOS_LOCAIS/GITHUB/brtos_github/examples/eclipse_gcc_mcf51qe128/Project_Headers" -I"C:/DADOS_LOCAIS/GITHUB/brtos_github/examples/eclipse_gcc_mcf51qe128/../brtos/brtos/includes" -I"C:/DADOS_LOCAIS/GITHUB/brtos_github/examples/eclipse_gcc_mcf51qe128/../brtos/hal/MemoryAllocation" -I"C:/DADOS_LOCAIS/GITHUB/brtos_github/examples/eclipse_gcc_mcf51qe128/../brtos/hal/GCC_CFV1" -Wall -Wextra -c -fmessage-length=0  -o "$@" $<
	@echo 'Finished building: $<'
	@echo ' '
